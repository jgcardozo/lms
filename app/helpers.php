        ...
        try {
            ...
            if ($image) {
                ...
                if ($course->logo_image) {
                    $form .= 'style="border: none; border-bottom: 0.1rem solid #dadada; padding-top: 10px; padding-bottom: 10px; background-image: url('.$course->getLogoImageUrlAttribute().'); width: 100%; text-align: left; background-color: white;"';
                } else {
