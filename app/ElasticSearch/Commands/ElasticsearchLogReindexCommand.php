...
class ElasticsearchLogReindexCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'elasticsearch:batch-reindex {model : The model that need to be indexed. Ex "App\User"}';
    ...
    public function handle()
    {
        ...
        if(class_exists($model)) {
            ...
            if(!$elastic->indexExists()) {
                ...
                $elastic->batchReindexModel($progressBar);
