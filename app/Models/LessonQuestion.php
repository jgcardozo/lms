...
class LessonQuestion extends Model
{
	...
	protected $fillable = [
		'question', 'video_url', 'video_title', 'description', 'featured_image', 'outer_url', 'featured_image', 'assessment_embed_id', 'assessment_id', 'lesson_id', 'is_tags', 'assessment_pass_tags', 'assessment_fail_tags'
	];
