...
function showLevels() 
{
    ...
    $(document).find("input[id*='session']").each(function () {
        if (valSelected == "yes") {
            ...
            $('.col-md-offset-3').css('display', 'table');
        } else {
            $(this).parent('.col-md-offset-2').css('display', 'none');
            $('.col-md-offset-3').css('display', 'none');
        }
    })
} //fn - showLevels
...
function ajaxCallModules()
{
    ...
    $.ajax({
        ...
        success: function success(response) {
            ...
            $(document).find("input[id*='resource']").each(function () {
                $(this).parent('.col-md-offset-3').css('display', 'none');
            }); */
        },
...
function htmlGeneratorVideo(session) {
    var html = '';
    if (type === "dripped") {
        html += '<div class="form-group" ><div class="input-group col-md-offset-3"><span class="input-group-addon" id="basic-addon3"><b>Video</b>: ' + session.video_url + '</span>';
        html += '<input type="number" min="0" class="form-control" name="sessions[' + session.id + ']" id="session_' + session.id + '" aria-describedby="basic-addon3">';
    } else {
        html += '<div class="form-group"><div class="input-group date dtp col-md-offset-3"><span class="input-group-addon" id="basic-addon3"><b>Video</b>: ' + session.video_url + '</span>';
        html += '<input type="text" class="form-control" name="sessions[' + session.id + ']" id="session_' + session.id + '" aria-describedby="basic-addon3"><span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>';
    }
...
function htmlGeneratorLearnmore(session) {
    var html = '';
    if (type === "dripped") {
        html += '<div class="form-group" ><div class="input-group col-md-offset-3"><span class="input-group-addon" id="basic-addon3"><b>LearnMore</b>: ' + session.title + '</span>';
        html += '<input type="number" min="0" class="form-control" name="sessions[' + session.id + ']" id="session_' + session.id + '" aria-describedby="basic-addon3">';
    } else {
        html += '<div class="form-group"><div class="input-group date dtp col-md-offset-3"><span class="input-group-addon" id="basic-addon3"><b>LearnMore</b>: ' + session.title + '</span>';
        html += '<input type="text" class="form-control" name="sessions[' + session.id + ']" id="session_' + session.id + '" aria-describedby="basic-addon3"><span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>';
    }
...
function htmlGeneratorResource(resource) {
    var html = '';
    if (type === "dripped") {
        html += '<div class="form-group"><div class="input-group col-md-offset-3"><span class="input-group-addon" id="basic-addon3"><b>Resource</b>: ' + resource.title + '</span>';
        html += '<input type="number" min="0" class="form-control" name="resources[' + resource.id + ']" id="resource_' + resource.id + '" aria-describedby="basic-addon3">';
    } else {
        html += '<div class="form-group"><div class="input-group date dtp col-md-offset-3"><span class="input-group-addon" id="basic-addon3"><b>Resource</b>: ' + resource.title + '</span>';
