                        ...
                        @if ($course->is_locked)
                            <div class="courseblock courseblock--locked"
                                ...
                                <div class="courseblock--locked-sign"
                                    @if ($course->is_date_locked) data-date=" until {{ date('d-m-Y', strtotime($lesson->getDate('lock_date'))) }}" @endif>
                                    <i class="icon--lock"></i>
                                </div>
                                ...
                                @else
                                    ...
                                    @else
                                        <a href="{{ route('single.course', $course->slug) }}"
                                            class="courseblock__link">Access Training <span class="arrow"></span></a>
                                    @endif
                                @endif
                            </div>
                        </div>
