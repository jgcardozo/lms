...
@section('content')
                                ...
                                <div class="form-group col-sm-6">
                                    <div class="input-group date dtp">
                                        ...
                                        <input type="text" class="form-control" name="day_zero" id="day_zero"
                                            value="{{ $entry->day_zero }}" placeholder="{{ $entry->day_zero }}">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            var placeholderValue = document.getElementById('day_zero').placeholder;
            console.log("Valor del atributo placeholder:", placeholderValue);
            document.getElementById('day_zero').value="juan";
        });*/
    </script>
@endsection
