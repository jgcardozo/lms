...
<script>
    ...
    export default {
        ...
        watch: {
          // Reflect the current page update to all existing pagination components at once
          customPager: function(customPager) {
            this.pager = customPager;
          },
          // Reflect the changes in items per page
          pageSize: function(itemsPerPage) {
        ...
        created () {
            ...
            // NOT USED - merge custom styles with default styles
            // if (this.styles) {
        ...
        methods: {
            setPage(page) {
                ...
                this.$emit('updatePagerDetails', pager);
            }
        }
    }
</script>